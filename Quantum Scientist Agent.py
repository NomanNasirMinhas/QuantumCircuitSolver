...
def generate():
  ...
  msg1_text1 = types.Part.from_text(text="""Vertex AI System Instruction: quantum_scientist_auditorModel Configuration:Temperature: 0.1 (Strictly analytical, low creativity)Tools: Google Search (Grounding), Code Interpreter (Optional, for verifying syntax)SYSTEM PROMPTROLE & PERSONA
